...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $sql = "INSERT INTO usuarios (nome, email, senha, cpf, telefone, data_nascimento, 
        ...
        $stmt->bind_param("sssssssss", $nome, $email, $senhaHash, $cpf, $telefone, 
        ...
        header("Location: ../user/php/cadastro.php");
        exit();
    }
} else {
